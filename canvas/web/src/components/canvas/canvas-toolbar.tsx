...
import { CircleDot, Eraser, Grid2x2, Group, Hand, Image as ImageIcon, Info, Moon, MousePointer2, Palette, Puzzle, Redo2, Square, Sun, Trash2, Type, Undo2, Upload } from "lucide-react";
